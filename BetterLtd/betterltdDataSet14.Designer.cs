...
namespace BetterLtd {
    ...
    public partial class betterltdDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/betterltdDataSet14.xsd";
        ...
        public partial class warehouseDataTable : global::System.Data.TypedTableBase<warehouseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public warehouseRow AddwarehouseRow(string warehouseName, string City, string Region, string Address) {
        ...
        public partial class warehouseRow : global::System.Data.DataRow {
            ...
            public string Region {
                get {
                    return ((string)(this[this.tablewarehouse.RegionColumn]));
                }
                set {
                    this[this.tablewarehouse.RegionColumn] = value;
                }
            }
...
namespace BetterLtd.betterltdDataSetTableAdapters {
    ...
    public partial class warehouseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `warehouse` WHERE ((`warehouseID` = @p1) AND (`warehouseName` = @p2) " +
                "AND (`City` = @p3) AND (`Region` = @p4) AND (`Address` = @p5))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `warehouse` (`warehouseName`, `City`, `Region`, `Address`) VALUES (@p" +
                "1, @p2, @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `warehouse` SET `warehouseName` = @p1, `City` = @p2, `Region` = @p3, `Addr" +
                "ess` = @p4 WHERE ((`warehouseID` = @p5) AND (`warehouseName` = @p6) AND (`City` " +
                "= @p7) AND (`Region` = @p8) AND (`Address` = @p9))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `warehouseID`, `warehouseName`, `City`, `Region`, `Address` FROM `warehous" +
                "e`";
        ...
        public virtual int Fill(betterltdDataSet.warehouseDataTable dataTable) {
        ...
        public virtual betterltdDataSet.warehouseDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            betterltdDataSet.warehouseDataTable dataTable = new betterltdDataSet.warehouseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(betterltdDataSet.warehouseDataTable dataTable) {
