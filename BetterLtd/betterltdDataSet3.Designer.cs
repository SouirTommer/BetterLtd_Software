...
namespace BetterLtd {
    ...
    public partial class betterltdDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/betterltdDataSet3.xsd";
        ...
        public partial class accountDataTable : global::System.Data.TypedTableBase<accountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public accountRow AddaccountRow(string Password, int isValid, System.DateTime RegDate) {
        ...
        public partial class staffDataTable : global::System.Data.TypedTableBase<staffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public staffRow AddstaffRow(accountRow parentaccountRowBystid, string Position, string FirstName, string LastName, string Gender, int StaffTel, decimal Salary, int isManager, int isAdmin) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        isManager,
                        isAdmin};
                if ((parentaccountRowBystid != null)) {
                    columnValuesArray[0] = parentaccountRowBystid[0];
                }
        ...
        public partial class accountRow : global::System.Data.DataRow {
            ...
            public int isValid {
                get {
                    return ((int)(this[this.tableaccount.isValidColumn]));
                }
                set {
                    this[this.tableaccount.isValidColumn] = value;
                }
            }
            ...
            public System.DateTime RegDate {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableaccount.RegDateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'RegDate\' in table \'account\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableaccount.RegDateColumn] = value;
                }
            }
            ...
            public bool IsRegDateNull() {
                return this.IsNull(this.tableaccount.RegDateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetRegDateNull() {
                this[this.tableaccount.RegDateColumn] = global::System.Convert.DBNull;
            }
        ...
        public partial class staffRow : global::System.Data.DataRow {
            ...
            public accountRow accountRow {
                get {
                    return ((accountRow)(this.GetParentRow(this.Table.ParentRelations["stid"])));
                }
                set {
...
namespace BetterLtd.betterltdDataSetTableAdapters {
    ...
    public partial class accountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `account` WHERE ((`AccountID` = @p1) AND (`Password` = @p2) AND (`isV" +
                "alid` = @p3) AND ((@p4 = 1 AND `RegDate` IS NULL) OR (`RegDate` = @p5)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `account` (`Password`, `isValid`, `RegDate`) VALUES (@p1, @p2, @p3)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `account` SET `Password` = @p1, `isValid` = @p2, `RegDate` = @p3 WHERE ((`" +
                "AccountID` = @p4) AND (`Password` = @p5) AND (`isValid` = @p6) AND ((@p7 = 1 AND" +
                " `RegDate` IS NULL) OR (`RegDate` = @p8)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BetterLtd.Properties.Settings.Default.betterltdConnectionString_stock;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `AccountID`, `Password`, `isValid`, `RegDate` FROM `account`";
        ...
        public virtual int Fill(betterltdDataSet.accountDataTable dataTable) {
        ...
        public virtual betterltdDataSet.accountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            betterltdDataSet.accountDataTable dataTable = new betterltdDataSet.accountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(betterltdDataSet.accountDataTable dataTable) {
